test_that("time_bins() works", {
  ...
  expect_equal(nrow(time_bins(interval = c("Fortunian", "Meghalayan"), equal = TRUE, size = 6)), 76)
  ...
  expect_equal(nrow(time_bins(interval = c("Fortunian", "Holocene"), scale = "GTS2012", equal = TRUE, size = 10)), 51)
