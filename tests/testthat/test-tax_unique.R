test_that("tax_unique() works", {
  ...
  dinosaurs <- data.frame(
    c("rex", "aegyptiacus", NA, NA, "rex"),
    c("Tyrannosaurus", "Spinosaurus", NA, NA, "Tyrannosaurus"),
    c(
      "Tyrannosaurus rex",
    ...
    c("Coelurosauria", "Orionides", NA, NA, "Coelurosauria"),
    c("Tetanurae", "Tetanurae", NA, "Neosauropoda", "Tetanurae")
  )
  colnames(dinosaurs) <- c(
    "species",
    "genus",
    "binomial",
    "family",
  ...
  #expect true
  expect_true(is.data.frame(tax_unique(
    occdf = tetrapods,
    genus = "genus",
    family = "family",
    order = "order",
