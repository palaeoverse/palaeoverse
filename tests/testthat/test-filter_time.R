test_that("filter_time works", {
  ...
  # Expect equal
  expect_equal(nrow(filter_time(occdf, bins = bins, interval_name = "interval_name", min_age = "a", max_age = "a")), 3)
  expect_equal(nrow(filter_time(occdf, bins = bins, interval_name = "interval_name", min_age = "b", max_age = "a")), 5)
  ...
  expect_equal(nrow(filter_time(occdf, bins = bins, interval_name = "interval_name", min_age = 0, max_age = 4, uncertainty = "bins", n_bins = 2)), 7)
  expect_equal(nrow(filter_time(occdf, bins = bins, interval_name = "interval_name", min_age = 0, max_age = 3, overlap = T)), 5)

  # Expect error
  expect_error(filter_time(occdf = 1))
  expect_error(filter_time(occdf))
  expect_error(filter_time(occdf, bins = 1))
  ...
  expect_error(filter_time(occdf, max_ma = "with_ch", bins = bins))
  expect_error(filter_time(occdf, bins = bins, min_age = "a", max_age = "a", overlap = 6))
  expect_error(filter_time(occdf, bins = bins[,c(1, 3, 4)], min_age = "a", max_age = "a"))
  expect_error(filter_time(occdf, bins = bins, youngest_bin = "a"))
  expect_error(filter_time(occdf, bins = bins, youngest_bin = "z"))
  expect_error(filter_time(occdf, bins = bins, min_age = 5, max_age = 2))
  expect_error(filter_time(occdf, min_ma = "Min_Ma", max_ma = "Max_Ma", bins = bins[,c(2, 3, 4)], min_age = "a", max_age = "a"))
  expect_error(filter_time(occdf, bins = bins, uncertainty = "1"))
  expect_error(filter_time(occdf, bins = bins, uncertainty = -1))
  expect_error(filter_time(occdf, bins = bins, uncertainty = c(1, 1)))
  ...
  expect_error(filter_time(occdf, bins = bins, uncertainty = "bins", retain.taxa = "a", taxa = "species"))
