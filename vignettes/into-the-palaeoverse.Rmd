...
In this example, we will use the `reefs` dataset to examine latitudinal trends in Phanerozoic reefs and demonstrate the functionality available in `palaeoverse`.
...
```{r echo = TRUE, eval = TRUE, fig.height=6, fig.width=7.2}
# Plot data
