...
rds_point_paleomap_reefs_exists <- file.exists("_data/palaeorotate_point_paleomap.rds")
```
...
```{r echo = FALSE, eval = !rds_point_paleomap_reefs_exists}
saveRDS(reefs, "_data/palaeorotate_point_paleomap.rds")
```

```{r echo = FALSE, eval = rds_point_paleomap_reefs_exists, warning = FALSE, message = FALSE}
reefs <- readRDS("_data/palaeorotate_point_paleomap.rds")
```
...
```{r, reefs-dist, echo = TRUE, eval = TRUE}
# Plot data
...
```{r, reefs-max, echo = TRUE, eval = TRUE}
...
```{r echo = FALSE, eval = TRUE}
rds_point_multi_models_exists <- file.exists("_data/palaeorotate_point_multi_models.rds")
```

```{r echo = TRUE, eval = !rds_point_multi_models_exists}
...
```{r echo = FALSE, eval = !rds_point_multi_models_exists}
saveRDS(reefs, "_data/palaeorotate_point_multi_models.rds")
```

```{r echo = FALSE, eval = rds_point_multi_models_exists, warning = FALSE, message = FALSE}
reefs <- readRDS("_data/palaeorotate_point_multi_models.rds")
```
