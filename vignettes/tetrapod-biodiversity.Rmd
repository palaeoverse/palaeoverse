...
rds_point_paleomap_tetrapods_exists <- file.exists("_data/palaeorotate_point_paleomap_tetrapods.rds")
```
...
head(maj_tetrapods[, c("cell_ID_100", "cell_centroid_lng_100", "cell_centroid_lat_100")])
```
...
unique_cells <- unique(maj_tetrapods[, c("bin_midpoint", "cell_ID_100")])
