---
title: "Spatial and temporal alpha diversity in Carboniferous and Permian tetrapods"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Spatial and temporal alpha diversity in Carboniferous and Permian tetrapods}
...
Looks good to me! Now that we have palaeocoordinates for our occurrences, we can put them into spatial bins. We can do this using the `bin_space` function, which provides a unique equal area grid cell reference for each occurrence. We've chosen a spacing of 100 here to match up with some analyses we're doing later.
