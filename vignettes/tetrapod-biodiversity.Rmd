...
```
##   bin interval_name  rank max_ma mid_ma min_ma duration_myr abbr  colour
## 1   1   Tournaisian stage  358.9 352.80  346.7         12.2    T #8CB06C
## 2   2        Visean stage  346.7 338.80  330.9         15.8    V #A6B96C
## 3   3  Serpukhovian stage  330.9 327.05  323.2          7.7   Se #BFC26B
## 4   4    Bashkirian stage  323.2 319.20  315.2          8.0    B #99C2B5
## 5   5     Moscovian stage  315.2 311.10  307.0          8.2    M #B3CBB9
## 6   6    Kasimovian stage  307.0 305.35  303.7          3.3   Ka #BFD0C5
##    font
## 1 black
## 2 black
## 3 black
...
```
## Warning in bin_time(occdf = cp_tetrapods, bins = bins, method = "mid"):
## One or more occurrences have a midpoint age equivalent to a bin boundary.
## Binning skipped for these occurrences. Hint:
...
## 
##            1            2            3            4            5 
## 0.2495559503 0.5192421551 0.1258140912 0.0793368857 0.0097690941 
##            6            7            8            9 
## 0.0100651273 0.0008880995 0.0005920663 0.0047365305
```
...
```
## [1] collection_no   max_ma          interval_mid_ma min_ma         
## [5] n_taxa         
...
```
##   bin_midpoint            taxon taxon_id      area
## 1       257.05        Abdalodon        1      0.00
## 2       257.05        Acrodenta        2      0.00
## 3       257.05      Adelosaurus        3      0.00
## 4       257.05    Aelurognathus        4 292392.77
## 5       257.05     Aelurosaurus        5  14698.41
## 6       257.05 Aenigmastropheus        6      0.00
```
