...
#' equal-length time bins based on the user's specified bin size (i.e. if a user specifies 10 Myr as their target bin size, the function will generate groups of bins that have a mean bin
