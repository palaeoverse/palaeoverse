...
#' length close to 10 Myr). However, users may also want consider grouping stages based on other reasoning e.g. availability of outcrop (see Dean et al. (2020); \doi{https://doi.org/10.1111/pala.12492}).
#'
