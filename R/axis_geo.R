...
#'   \code{tick_at}, or b) a custom \code{character} or \code{expression} vector
#'   of labels to be placed at the tick marks. If \code{tick_at} is specified,
#'   this argument is passed directly to \code{\link[graphics]{axis}}.
#' @param title \code{character}. An axis title to be added outside of the
#'   specified axis. This is passed directly to \code{\link[graphics]{mtext}}.
#'   If this is set to \code{NULL} (the default), no title will be added.
