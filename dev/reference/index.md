...
- [`phylo_check()`](https://palaeoverse.palaeoverse.org/dev/reference/phylo_check.md)
...
- [`palaeorotate()`](https://palaeoverse.palaeoverse.org/dev/reference/palaeorotate.md)
  : Palaeorotate fossil occurrences
- [`look_up()`](https://palaeoverse.palaeoverse.org/dev/reference/look_up.md)
  : Look up geological intervals and assign geological stages
- [`tax_expand_lat()`](https://palaeoverse.palaeoverse.org/dev/reference/tax_expand_lat.md)
  : Generate pseudo-occurrences from latitudinal range data
- [`tax_expand_time()`](https://palaeoverse.palaeoverse.org/dev/reference/tax_expand_time.md)
  : Generate pseudo-occurrences from temporal range data
- [`tax_certainty()`](https://palaeoverse.palaeoverse.org/dev/reference/tax_certainty.md)
...
- [`bin_lat()`](https://palaeoverse.palaeoverse.org/dev/reference/bin_lat.md)
  : Assign fossil occurrences to latitudinal bins
- [`bin_space()`](https://palaeoverse.palaeoverse.org/dev/reference/bin_space.md)
  : Assign fossil occurrences to spatial bins
- [`bin_time()`](https://palaeoverse.palaeoverse.org/dev/reference/bin_time.md)
...
- [`tax_range_time()`](https://palaeoverse.palaeoverse.org/dev/reference/tax_range_time.md)
...
- [`axis_geo()`](https://palaeoverse.palaeoverse.org/dev/reference/axis_geo.md)
  [`axis_geo_phylo()`](https://palaeoverse.palaeoverse.org/dev/reference/axis_geo.md)
  : Add an axis with a geological timescale
- [`tax_range_strat()`](https://palaeoverse.palaeoverse.org/dev/reference/tax_range_strat.md)
...
- [`lat_bins()`](https://palaeoverse.palaeoverse.org/dev/reference/lat_bins.md)
...
- [`lat_bins_area()`](https://palaeoverse.palaeoverse.org/dev/reference/lat_bins_area.md)
  [`plot(`*`<palaeoverse_lat_bins_area>`*`)`](https://palaeoverse.palaeoverse.org/dev/reference/lat_bins_area.md)
...
- [`time_bins()`](https://palaeoverse.palaeoverse.org/dev/reference/time_bins.md)
  : Generate time bins
- [`group_apply()`](https://palaeoverse.palaeoverse.org/dev/reference/group_apply.md)
...
- [`GTS2012`](https://palaeoverse.palaeoverse.org/dev/reference/GTS2012.md)
  : Geological Timescale 2012
- [`GTS2020`](https://palaeoverse.palaeoverse.org/dev/reference/GTS2020.md)
  : Geological Timescale 2020
- [`interval_key`](https://palaeoverse.palaeoverse.org/dev/reference/interval_key.md)
  : Example dataset: Interval key for the look_up function
- [`reefs`](https://palaeoverse.palaeoverse.org/dev/reference/reefs.md)
  : Example dataset: Phanerozoic reefs from the PaleoReefs Database
- [`tetrapods`](https://palaeoverse.palaeoverse.org/dev/reference/tetrapods.md)
